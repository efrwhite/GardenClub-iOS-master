...
class EmbedMapVC: UIViewController, GMSMapViewDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        let camera = GMSCameraPosition.camera(withLatitude: 34.191113, longitude: -77.838259, zoom: 10.0)
        ...
        marker1 = GMSMarker()
        marker1.position = CLLocationCoordinate2D(latitude: 34.191874, longitude: -77.837544)
        marker1.title = "1"
        marker1.icon = self.drawText(text: "1", inImage: #imageLiteral(resourceName: "icon.png"))
        marker1.map = mapView
        
        marker2 = GMSMarker()
        marker2.position = CLLocationCoordinate2D(latitude: 34.191052, longitude: -77.835065)
        marker2.title = "2"
        ...
        marker4 = GMSMarker()
        marker4.position = CLLocationCoordinate2D(latitude: 34.215712, longitude: -77.807243)
        marker4.title = "4"
        marker4.icon = self.drawText(text: "4", inImage: #imageLiteral(resourceName: "icon.png"))
        marker4.map = mapView
        
        marker5 = GMSMarker()
        marker5.position = CLLocationCoordinate2D(latitude: 34.233283, longitude: -77.852662)
        marker5.title = "5"
        marker5.icon = self.drawText(text: "5", inImage: #imageLiteral(resourceName: "icon.png"))
        marker5.map = mapView
        
        marker6 = GMSMarker()
        marker6.position = CLLocationCoordinate2D(latitude: 34.228586, longitude: -77.912327)
        marker6.title = "6"
        marker6.icon = self.drawText(text: "6", inImage: #imageLiteral(resourceName: "icon.png"))
        marker6.map = mapView
        
        marker7 = GMSMarker()
        marker7.position = CLLocationCoordinate2D(latitude: 34.234054, longitude: -77.912885)
        marker7.title = "7"
        marker7.icon = self.drawText(text: "7", inImage: #imageLiteral(resourceName: "icon.png"))
        marker7.map = mapView
        
        marker8 = GMSMarker()
        marker8.position = CLLocationCoordinate2D(latitude: 34.239137, longitude: -77.926989)
        marker8.title = "8"
        marker8.icon = self.drawText(text: "8", inImage: #imageLiteral(resourceName: "icon.png"))
        marker8.map = mapView
        
        marker9 = GMSMarker()
        marker9.position = CLLocationCoordinate2D(latitude: 34.239108, longitude: -77.927202)
        marker9.title = "9"
        marker9.icon = self.drawText(text: "9", inImage: #imageLiteral(resourceName: "icon.png"))
        marker9.map = mapView
        
        marker10 = GMSMarker()
        marker10.position = CLLocationCoordinate2D(latitude: 34.238595, longitude: -77.926464)
        marker10.title = "10"
        marker10.icon = self.drawText(text: "10", inImage: #imageLiteral(resourceName: "icon.png"))
        marker10.map = mapView
        
        marker11 = GMSMarker()
        marker11.position = CLLocationCoordinate2D(latitude: 34.239208, longitude: -77.943111)
        marker11.title = "11"
        marker11.icon = self.drawText(text: "11", inImage: #imageLiteral(resourceName: "icon.png"))
        marker11.map = mapView
        
        marker12 = GMSMarker()
        marker12.position = CLLocationCoordinate2D(latitude: 34.151580, longitude: -77.902439)
        marker12.title = "12"
